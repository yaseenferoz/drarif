...
export default function Home() {
  return <>
    <section className="hero">
      ...
      <div className="shell hero-grid">
        <div className="hero-copy">
          <div className="availability"><span/> Appointments open this week</div>
          <h1>Advanced digestive care.<br/><em>Humanly delivered.</em></h1>
          <p>Specialist GI, cancer, liver–pancreas and keyhole surgery with clear guidance at every step.</p>
    ...
    <section className="section article-section"><div className="shell"><div className="section-heading split"><div><span className="eyebrow">HEALTH LIBRARY</span><h2>Knowledge for better decisions.</h2></div><Link className="text-link" href="/articles">Browse all articles <ArrowRight/></Link></div><ArticleGrid limit={3}/></div></section>
